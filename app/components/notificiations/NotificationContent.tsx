...
const NotificationContent = ({ notifications }: NotificationProps) => {
  return (
    <div className="font-normal text-base pb-24 md:pb-0">
      <ul className="space-y-3 divide-y ">
        {notifications.map((info, i) => (
          <li
            key={i}
            className="grid md:grid-cols-[40px_minmax(0,1fr)_105px] grid-cols-[40px_minmax(0,1fr)] items-center py-5"
          >
            <svg
            ...
            {/* <span className="text-right">{info.timeOfNotification}</span> */}
          </li>
        ))}
      </ul>
    </div>
