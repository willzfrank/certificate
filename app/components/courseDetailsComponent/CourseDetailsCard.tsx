  ...
  return (
    <div className="flex items-start justify-start flex-col">
      ...
      <div className="w-[286px] h-[335px] flex-col justify-start items-start gap-2 inline-flex">
        ...
        <div
          className="h-[250px] w-full p-3 rounded-lg border border-red-200 flex-col justify-start items-start gap-6 flex"        >
          <div className="self-stretch justify-start items-center gap-[9px] inline-flex">
            <div className="w-[26px] h-[26px] relative">
              ...
              <div className="w-5 h-2.5 left-[5px] top-[5px] absolute text-neutral-700 text-xs font-medium font-['Inter']">
                T1
              </div>
            </div>
            <div className="text-neutral-700 text-xs font-medium font-['Inter']">
              Rules of Networking
            </div>
          </div>
          <div className="self-stretch justify-start items-center gap-[9px] inline-flex">
