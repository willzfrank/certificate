...
const CourseDetailsModules = (props: Props) => {
  return (
    <div>
      <div className="flex items-center justify-between">
        ...
        <div>
          <span className="text-neutral-400 text-sm font-medium font-['Inter'] leading-tight">
            Duration:
          </span>
          <span className="text-neutral-700 text-sm font-medium font-['Inter'] leading-tight">
            {' '}
            4 Weeks
          </span>
        </div>
        ...
        <div className="w-full p-3 space-x-5 md:border-l-2 md:border-neutral-700 justify-start items-start md:items-center gap-px inline-flex flex-col md:flex-row">
          ...
          <div className="flex items-start md:items-center space-y-2 md:space-y-0  md:space-x-2 flex-col md:flex-row">
            <div className="flex md:items-center space-x-1">
              ...
              <div className="text-neutral-600 w-max text-sm font-medium font-['Inter'] leading-tight">
                Certificate issued
              </div>
            </div>
      ...
      {/* CARD MODULES */}
      <div className="items-center grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 space-y-4">
        <CourseDetailsCard />
        <CourseDetailsCard />
        <CourseDetailsCard />
        <CourseDetailsCard />
