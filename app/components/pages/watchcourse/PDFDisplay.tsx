...
const PDFError = (props: { errorType: "load" | "source" }) => {
	return <p className="text-white text-center">AN ERROR OCCURRED WHILE LOADING PDF {props.errorType}</p>;
};

const PDFDisplay = (props: PDFViewerProps) => {
	return (
		<div className={`${styles.pdfDisplayMain} mb-10 w-screen`}>
			<div className="p-6 bg-transparent w-full text-white rounded-sm" style={{ boxShadow: "0px 5px 10px #2b2a2a" }}>
