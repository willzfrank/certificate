...
> = ({ courseId, module, moduleIndex, openModuleId, courseType, subscribed, setShowModal }, ref) => {
  ...
  const handleResourceClick = (
    ...
    if (resourceguards.isAssessment(newActiveResource)) {
      router.push(
        `${
          userRole?.toLowerCase() === USERTYPES.INSTRUCTOR ? '/instructors' : ''
  ...
  const mergedList = React.useMemo(
    () => getAllModuleResources(moduleContent?.data),
    [moduleContent?.data]
  );
  ...
  const handleAccordionItemClick = (module: CourseModules) => {
    if (module?.paymentRequired && courseType !== 'free' && !subscribed) {
      // Show the modal
      if (setShowModal) {
        setShowModal(true);
      }
    ...
    <Accordion.Item
      ...
      head={({ isOpen }) => (
        <div
          ...
          onClick={() => handleAccordionItemClick(module)}
        >
          <div className="flex-1">
            <p className="text-app-dark-400 truncate text-[15px] md:text-base w-[250px]">
              {module.name}
            </p>
            <p className="text-muted text-[15px]">
              {moduleContent
                ? getTime(
                    moduleContent.data.totalSeconds * 1000,
                    'MM mins',
                    'absolute'
                  )
                : ''}
                ...
                return (
                  ...
                  >
                    <div className="grid grid-cols-[2rem,auto]">
                      <div
                        className={`w-6 h-6 items-center justify-center flex rounded-full border ${
                          item.isWatched
                      ...
                      >
                        {item.isWatched ? (
                          ...
                          >
                            <path
                              d="M1 2.99963L3.66742 5.66592L9.33333 1"
                              stroke="white"
                              strokeWidth="2"
                              strokeLinecap="round"
                              strokeLinejoin="round"
                          ...
                          <svg
                            className="scale-125 translate-x-[1px]"
                            width="6"
                            height="8"
                            viewBox="0 0 6 8"
                            fill="none"
                    ...
                    <p>
                      {getTime(item.totalSeconds * 1000, 'MM mins', 'absolute')}
                    </p>
                  </button>
                );
                ...
                return (
                  <button
                    ...
                    onClick={() => {
                      handleResourceClick(
                        index,
                        ModuleContentTypes.selectAnAnswer,
                        moduleIndex
                      );
                    }}
                  >
                ...
                return (
                  <button
                    ...
                    onClick={() => {
                      handleResourceClick(
                        index,
                        ModuleContentTypes.clickAndMatch,
                        moduleIndex
                      );
                    }}
                  >
                ...
                return (
                  <button
                    ...
                    onClick={() => {
                      handleResourceClick(
                        index,
                        ModuleContentTypes.fillInTheBlank,
                        moduleIndex
                      );
                    }}
                  >
                ...
                return (
                  <button
                    ...
                    onClick={() => {
                      handleResourceClick(
                        index,
                        ModuleContentTypes.allThatApply,
                        moduleIndex
                      );
                    }}
                  >
                ...
                return (
                  ...
                  >
                    <div className="flex space-x-3 items-center">
                      ...
                      <p className="truncate lg:w-[250px] text-left ">
                        {item.displayName}
                      </p>
                    </div>
                  </button>
