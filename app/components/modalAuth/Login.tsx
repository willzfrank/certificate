...
const Login = (props: AuthProps) => {
  ...
  console.log('courseSubscribed', courseSubscribed)
  useEffect(() => {
    ;(async () => {
      if (user?.token) {
        try {
  ...
  return (
    <form onSubmit={handleSubmit(handleLogin)}>
      ...
      <button
        type="submit"
        className="w-full md:w-[460px] h-[59px] px-3 py-5 bg-gradient-to-r from-red-500 to-rose-600 rounded-lg justify-center items-center gap-px inline-flex"
        disabled={isLoading}
      >
