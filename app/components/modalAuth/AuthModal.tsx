...
const AuthModal: React.FC<AuthProps> = ({
  ...
  const tabClass = (tabIndex: number) =>
    `text-xl w-[215px] justify-center font-medium font-['Inter'] py-3 px-4 flex items-center gap-x-2 rounded-lg hover:hover:text-neutral-700 disabled:opacity-50 disabled:pointer-events-none dark:hover:text-gray-300 ${
      activeTab === tabIndex
  ...
  return (
    <div className="w-full h-full min-h-screen flex items-center justify-center">
      <div className="w-[590px] h-max px-16 py-5 bg-white rounded-2xl justify-start items-start gap-px flex-col flex">
