...
const CourseCreationContext = React.createContext<{
	...
	updateCertificateRequired: (value: CourseCreationContextFields["certificateRequired"]) => void;
	...
	updateCourseMedia: (value: CourseCreationContextFields["courseMedia"]) => void;
	updateCourseModules: (value: CourseCreationContextFields["courseModules"]) => void;
}>({
	courseInfo: {
		id: "",
		courseName: "",
