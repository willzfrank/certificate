...
const SearchCourses: NextPageWithLayout<{}> = () => {
  ...
  const {
    ...
    loading,
    isLast,
  } = usePaginatedQuery(courseApi.endpoints.searchCourses, params)
    ...
    <>
      ...
      <div className="flex px-6 md:p-14 md:py-20 md:gap-8 w-full items-start">
        ...
        <div className="flex flex-col w-full">
          <SearchBar resetSearch={reset} query={params?.query as string}>
            <div className="flex space-x-2">
              <button
                type="button"
                onClick={openModal}
...
SearchCourses.getLayout = function (page) {
  return (
