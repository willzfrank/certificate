...
function MyApp({ Component, pageProps }: AppPropsWithLayout) {
	...
	return (
		<>
			<Script strategy="lazyOnload" src="https://www.googletagmanager.com/gtag/js?id=G-MQDNXW4B73" />
			<Script
				id="google-analytics"
				strategy="lazyOnload"
			...
			<Provider store={store}>
				...
				<PersistAuthState>
					<CookiesProvider>
						<NotifyWrapper>
							<DragAndDropContainer>{getLayout(<Component {...pageProps} />)}</DragAndDropContainer>
						</NotifyWrapper>
					</CookiesProvider>
				</PersistAuthState>
			</Provider>
