...
import { SingleCourseDetailsResponse, NextPageWithLayout, USERTYPES } from "app/types"; // import { shuffle } from 'app/utils'
...
CourseDetails.getLayout = function (page) {
	return <CourseDetailsLayout allowedUserTypes={[USERTYPES.INSTRUCTOR, USERTYPES.STUDENT]}>{page}</CourseDetailsLayout>;
};
